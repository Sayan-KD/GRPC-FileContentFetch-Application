...
public final class filesGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.telaverge.client.Files.FetchRequest,
      com.telaverge.client.Files.FetchResponse> getFetchcontentsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "fetchcontents",
      requestType = com.telaverge.client.Files.FetchRequest.class,
      responseType = com.telaverge.client.Files.FetchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.telaverge.client.Files.FetchRequest,
      com.telaverge.client.Files.FetchResponse> getFetchcontentsMethod() {
    io.grpc.MethodDescriptor<com.telaverge.client.Files.FetchRequest, com.telaverge.client.Files.FetchResponse> getFetchcontentsMethod;
      ...
      synchronized (filesGrpc.class) {
        if ((getFetchcontentsMethod = filesGrpc.getFetchcontentsMethod) == null) {
          filesGrpc.getFetchcontentsMethod = getFetchcontentsMethod = 
              io.grpc.MethodDescriptor.<com.telaverge.client.Files.FetchRequest, com.telaverge.client.Files.FetchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "files", "fetchcontents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.telaverge.client.Files.FetchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.telaverge.client.Files.FetchResponse.getDefaultInstance()))
  ...
  public static abstract class filesImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void fetchcontents(com.telaverge.client.Files.FetchRequest request,
        io.grpc.stub.StreamObserver<com.telaverge.client.Files.FetchResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.telaverge.client.Files.FetchRequest,
                com.telaverge.client.Files.FetchResponse>(
  ...
  public static final class filesBlockingStub extends io.grpc.stub.AbstractStub<filesBlockingStub> {
    ...
    /**
     */
    public com.telaverge.client.Files.FetchResponse fetchcontents(com.telaverge.client.Files.FetchRequest request) {
  ...
  public static final class filesFutureStub extends io.grpc.stub.AbstractStub<filesFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.telaverge.client.Files.FetchResponse> fetchcontents(
        com.telaverge.client.Files.FetchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FETCHCONTENTS:
          serviceImpl.fetchcontents((com.telaverge.client.Files.FetchRequest) request,
              (io.grpc.stub.StreamObserver<com.telaverge.client.Files.FetchResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class filesBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.telaverge.client.Files.getDescriptor();
    }
